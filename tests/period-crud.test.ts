...
const PUEDE_GESTIONAR_PERIODOS = { ADMIN: true, DIRECCION: false, ARMADOR: true, LOGISTICA: false, RECEPCION: false, PAGOS: false } as const; // los roles de plata no gestionan eventos ni períodos
